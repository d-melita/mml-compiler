...
void mml::frame_size_calculator::do_write_node(mml::write_node *const node, int lvl) {
  // EMPTY
}
...
void mml::frame_size_calculator::do_function_def_node(mml::function_def_node *const node, int lvl) {
    node->block()->accept(this, lvl + 2);
}
